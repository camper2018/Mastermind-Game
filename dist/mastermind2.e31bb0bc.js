...
function _generateRandomSequence() {
  _generateRandomSequence = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(num, max) {
    var isUnique, response, randomSequence, sequence, uniqueSequence, colorSequence, _response, _randomSequence, _sequence, _colorSequence;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            uniqueSequence = _toConsumableArray(new Set(sequence));
          ...
          case 34:
            ...
            _randomSequence = _response.data;
            _context.next = 38;
            return _randomSequence.trim().split("\n");

          case 38:
            _sequence = _context.sent;
            console.log(_sequence);
            _context.next = 42;
            return getRandomColorSequence(_sequence);

          case 42:
            _colorSequence = _context.sent;
            // return randomSequence;
            console.log(_colorSequence);
            _context.next = 46;
...
function setGameDifficulty(difficulty) {
  ...
  globalStore.columnIds.forEach(function (id, i) {
    ...
    $container.append(colsPerAttempt); // $(`#${id}`).append($container);

    $("#".concat(id)).html($container);
    colsPerAttempt = [];
  });
}
  ...
  generateRandomSequence(codeLength, 7).then(function (secret) {
    ...
    $(".settings-btn").on("click", function (e) {
      ...
      $(".btn-submit").on("click", function (e) {
        e.preventDefault();
        var formData = $("input[type=\"radio\"].form-check").val(jQuery(this));
        $("#modal-form input").each(function (i, field) {
          if (field.checked) {
          ...
          if (field.id === "easy" || field.id === "medium" || field.id === "hard") {
            ...
            if (field.id === "none" || field.id === "250" || field.id === "500" || field.id === "1000") {
...
$(function () {
  $(".myModal").hide(); // const globalStore = initGame();
  ...
  showModal("GAME INSTRUCTIONS", instructions, "Play", "Cancel", restartGame, hideModal // handleSettings
...
//# sourceMappingURL=/mastermind2.e31bb0bc.js.map